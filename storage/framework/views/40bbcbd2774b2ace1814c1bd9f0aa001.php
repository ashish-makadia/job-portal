            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item" id="guestSection">
                        <div class="d-flex">
                            <a class="btn btn-outline-light me-2" href="<?php echo e(route('login')); ?>">
                                <i class="fas fa-sign-in-alt me-1"></i>Sign In
                            </a>
                            <a class="btn btn-light" href="<?php echo e(route('register')); ?>">
                    ...
                    <li class="nav-item dropdown" id="userSection" style="display: none;">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="<?php echo e(route('dashboard')); ?>" id="profileLink"><i class="fas fa-user me-2"></i>Dashboard</a></li>
...
</html><?php /**PATH C:\wamp64\www\job-board\resources\views/home.blade.php ENDPATH**/ ?>